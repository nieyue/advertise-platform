...
<template>
    <div class="body-wrap">
      ...
      <Table border :columns='mediaCollectionColumns' :data='mediaCollectionList' ref='table' size="small"></Table>
   ...
   getList () {
     ...
     */
     this.axiosbusiness.getList(this,{
       countUrl:'/mediaCollection/count',
       listUrl:'/mediaCollection/list',
