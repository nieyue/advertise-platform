...
<template>
    ...
    <div class="body-btn-wrap">
      <div class="search-wrap">
        ...
        <a style="display:inline-block;margin-right:0;float:right;" :href="goWeixinauth" target="_black"><Button type="primary" size="large" shape="circle" >增加媒体</Button></a>
        <!-- <Button type='primary'  @click='add' style="float:right;" shape="circle" icon="md-add" size="large">增加媒体</Button> -->
      </div>
    </div>
	<!--新增 -->
       ...
       /*  {
        ...
        },
        {
          ...
          render: (h, params) => {
            ...
            params.row.name)
            let accountName=h('div',params.row.accountName)
            hh=h("div",[
                img,
                h("div",{
                style: {
